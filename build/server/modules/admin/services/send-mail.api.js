...
import { EmailDataSchema } from "#src/shared/schemas/email-data";
...
export default api({
    ...
    const transporter = Object.values(mailTransporters)
        ...
        ?.transporter();
    if (!transporter) {
        throw HttpException.badRequest("The sender email provided is not authenticated. Please, use a different address");
    }
