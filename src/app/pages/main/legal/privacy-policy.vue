      ...
      <div class="px-4 md:px-28 xl:px-32">
        <section id="terms-of-use" class="py-10">
          <div>
            <header class="grid gap-2">
              ...
              <Message class="mt-2">
                <div class="flex items-start gap-2">
                  ...
                  <p>
                    This Privacy Policy outlines how {{ APP_NAME }} (“we”, “us”,
                    or “our”) collects, uses, stores, and protects your personal
                    information when you use our platform and services. We are
                    committed to protecting your privacy and ensuring the
                    security of your personal data. <br /><br />
                    By using {{ APP_NAME }}'s platform, you agree to the
                    collection and use of information in accordance with this
                    policy. If you do not agree with this Privacy Policy, please
            ...
            <div class="mt-6 grid gap-5">
              <div v-for="item in pp" :key="item.title" class="grid gap-1">
        ...
        <section id="contact-us" class="py-10">
          ...
          <div>
            ...
            <p>
              Email: <span class="font-semibold">{{ SUPPORT_EMAIL }}</span>
            </p>
          </div>
        </section>
      </div>
