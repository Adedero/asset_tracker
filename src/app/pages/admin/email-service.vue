...
function validate() {
  ...
  if (
    !data ||
    data.startsWith("<p><br></p>") ||
    data.startsWith("<p>Enter your message...</p>")
  ) {
      ...
      <div class="mt-4">
        <header class="grid gap-1">
          <div class="grid items-center md:grid-cols-12">
            ...
            <EmailAddressField
              class="col-span-11"
              v-model:addresses="emailData.to"
            />
          </div>
          ...
          <div class="grid items-center md:grid-cols-12">
            ...
            <EmailAddressField
              class="col-span-11"
              v-model:addresses="emailData.cc"
            />
          </div>
          ...
          <div class="grid items-center md:grid-cols-12">
            ...
            <EmailAddressField
              class="col-span-11"
              v-model:addresses="emailData.bcc"
            />
          </div>
