...
import type { InvestmentPlan, UserTier } from "@/prisma-gen";
...
const plan = ref<Partial<InvestmentPlan & { userTiers: UserTier[] }>>({});
...
const {
  ...
  [investment_plan_id ? "put" : "post"](plan)
  .json();
          ...
          <div class="grid md:grid-cols-3 gap-4 h-full">
            <div class="md:col-span-1">
              <div class="grid gap-2">
                <div class="bg-slate-200 dark:bg-slate-700 rounded-md h-54 overflow-hidden">
              ...
              <div class="mt-2">
                <div class="grid gap-4">
                  ...
                  <div class="grid gap-1">
                    ...
                    <UserTiersSelect
                      v-model="plan.userTiers"
                      multiple
                      filter
                      placeholder="Select User Tier"
                    />
                  </div>
                </div>
              </div>
            ...
            <div class="md:col-span-2 h-full overflow-y-auto">
              <div v-if="plan.tiers" class="grid gap-4">
                <VCard v-for="(tier, index) in plan.tiers" :key="tier.name" :header="tier.name">
                  ...
                  <div
                    class="mt-2 grid grid-cols-[repeat(auto-fill,minmax(200px,1fr))] gap-x-4 gap-y-6"
                  >
                    ...
                    <div class="grid">
                      ...
                      <InputNumber
                        v-model="tier.expectedReturnRate"
                        suffix="%"
                        :max-fraction-digits="2"
                        fluid
                      />
