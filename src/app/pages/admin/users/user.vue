...
<template>
  <VueLayout name="admin">
    <div>
      <VCard class="!py-2">
        <div
          class="flex items-center gap-1 justify-between flex-wrap whitespace-pre-wrap"
        >
            ...
            <VCard class="bg-gradient-x text-white">
              <div class="flex items-center gap-4 flex-wrap">
                ...
                <div>
                  ...
                  <p
                    v-if="data.user.region || data.user.country"
                    class="text-sm"
                  >
              ...
              <VCard class="grid gap-2" header="Profile">
                ...
                >
                  <div class="flex items-center">
                    <span
                      class="pi pi-ban text-red-400 p-1 rounded-full"
                  ...
                  <p
                    v-if="data.user.ban.expiresAt"
                    class="text-right text-sm text-red-400"
                  >
                    Banned until
                    {{
                      useDateFormat(
                        data.user.ban.expiresAt,
            ...
            <VCard header="Account" class="mt-2">
              <div class="flex flex-col gap-2 *:flex-shrink-0">
                ...
                >
                  <div class="flex items-center">
                    <span
                      class="pi pi-users text-mute p-1 rounded-full"
                      style="font-size: 12px"
                    />
                ...
                >
                  <div class="flex items-center">
                    <span
                      class="pi pi-shield text-mute p-1 rounded-full"
                      style="font-size: 12px"
                    />
                    <p class="text-mute text-sm font-semibold">
                      KYC Verification
                  ...
                  <div class="text-sm grid mt-2 gap-1">
                    <div class="flex flex-wrap gap-2 justify-between">
                      <p>Status</p>
                      <p class="font-semibold">
                        {{ toTitleCase(data.user.account?.kycStatus) }}
                      </p>
                    </div>
                    ...
                    >
                      ...
                      <p class="font-semibold">
                        {{
                          useDateFormat(
                            new Date(data.user.account.kycSubmittedAt),
                            "MMM DD, YYYY"
                          )
                        }}
                      </p>
            ...
            <VCard header="Settings" class="mt-2">
              <div class="grid gap-2">
                ...
                >
                  ...
                  <div>
                    <p class="text-xs text-mute">
                      Modify this user's email address
                    </p>
                  </div>
                ...
                >
                  <div class="flex items-center">
                    <span
                      class="pi pi-lock text-mute p-1 rounded-full"
                      style="font-size: 12px"
                    />
                    <p class="text-mute-500 text-sm font-semibold">
                      Reset Password
                    </p>
                  </div>
                  <div>
                    <p class="text-xs text-mute">
                      Reset this user's password to the default '00000000' (8
                      zeros)
                    </p>
                  </div>
                ...
                >
                  ...
                  <div>
                    <p class="text-xs text-red-500">
                      Delete this user and all related details from the
                      database.
                    </p>
                  </div>
