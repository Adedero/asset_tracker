...
<template>
  <div class="text-[0.78rem] bg-slate-200 dark:bg-primary-800">
    <div
      class="pt-12 pb-4 px-4 lg:px-12 grid items-start md:grid-cols-4 md:justify-evenly gap-5"
    >
    ...
    <div class="w-full flex item-center justify-center py-4 px-4 mb-4">
      <Message>
        ...
        <p class="text-sm font-normal">
          The price of securities fluctuate, sometimes dramatically. This price
          may move up or down, and may become valueless. It is very likely that
          losses will be incurred, rather than profit, as a result of buying and
          selling securities.
        </p>
      </Message>
    </div>
    ...
    >
      <p>
        Copyright © {{ COPYRIGHT_YEAR }} - {{ new Date().getFullYear() }}
