...
export interface WithdrawalCeateApiResponse extends ApiResponse {
  ...
  defineHandler(async (req) => {
    ...
    if (lastWithdrawalRequest) {
      throw HttpException.badRequest(
        "Possible duplicate withdrawal request detected. Please, wait a little before trying again."
      );
    }
    ...
    const payload: WithdrawalCeateApiResponse = {
      success: true,
